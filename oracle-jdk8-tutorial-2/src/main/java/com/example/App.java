...
public class App {
    public static void main(String[] args) {
    	...
    	// Si quiero comprobar si las variables x e y son iguales, podemos utilizar una sentencia de Java
    	// que la tienen todos los lenguajes de programacion, denominada sentencia condicional if - else
    	// que evalua una condicion entre parentesis, y que si se cumple se ejecuta el grupo de sentencias 
    	// que aparecen en el bloque encerrado entre las llaves de apartura y cierre, y si no se cumple la condicion
    	...
    	/* Para saber si el contenido de dos objetos es el mismo se utiliza el metodo equals, porque el operador
    	 * == lo que comprueba en el caso de objetos es si dichos objetos estan en la misma ubicacion de la memoria
    	 * */
